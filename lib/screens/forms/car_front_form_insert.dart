...
class CarFrontFormScreen extends StatefulWidget {

  CarFrontFormScreen({Key? key, required this.customer, required this.form, this.operation = 'add'}) : super(key: key);
  CarFrontForm form;
  Customer customer ;
  String operation;
  @override
  _CarFrontFormScreenState createState() => _CarFrontFormScreenState();
}

class _CarFrontFormScreenState extends State<CarFrontFormScreen> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('فحص مقدمة المركبة', style: TextStyle(color: txtColor),),
        centerTitle: true,
      ...
      body: Padding(
        ...
        child: ListView(
          children: [
            ...
            getLabelAndTextUI(context, "واجهة امامية", "", widget.form.c3),
            getLabelAndTextUI(context, "جناح امامي ايمن", "", widget.form.c4),
            getLabelAndTextUI(context, "جناح امامي ايسر", "", widget.form.c5),
            getLabelAndTextUI(context, "غطاء المحرك", "", widget.form.c6),
            getLabelAndTextUI(context, "صدر المركبة", "", widget.form.c7),
